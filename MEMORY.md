...
- O usuário (Ami) prefere execução prática: quer que eu faça o necessário de ponta a ponta, sem pedir confirmação a cada microetapa.
- Valoriza condução passo a passo quando necessário, mas com foco em entrega funcional.
